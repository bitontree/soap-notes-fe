...
export default function ClaimCopilot({ onBack, onSuccess, selectedPatient, selectedSourceId, selectedCodes, patientRecord }: ClaimCopilotProps) {
    ...
    const startAnalysis = async () => {
        ...
        try {
            const result = await billingCodesApi.analyzeNecessity({
                ...
                appointment_id: patientRecord.appointment_id || patientRecord.appointmentId,
